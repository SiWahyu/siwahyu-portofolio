...
export default function About({ ref }) {
  ...
  return (
    <div
      className="container h-screen flex flex-col mx-auto space-y-6 lg:py-16 lg:flex-row lg:items-center bg-transparent"
      ref={ref}
    >
      ...
      <div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
        <div className="max-w-lg lg:mx-12 border border-gray-800 p-7 rounded-3xl m-3">
          <h1 className="text-3xl font-bold tracking-wide text-white lg:text-4xl">
            About Me
          </h1>
          <p className="mt-5 text-white text-justify text-xl">
