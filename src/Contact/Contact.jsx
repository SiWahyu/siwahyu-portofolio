        ...
        <div className="grid grid-cols-1 gap-12 mt-12 lg:grid-cols-2">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 justify-center items-center">
            {socialMedia.map((item, index) => (
              <CardSocialMedia key={index}>
                <CardSocialMedia.Icon icon={item.icon} />
                <CardSocialMedia.Title title={item.title} />
                <CardSocialMedia.Body deskripsi={item.text} link={item.link} />
              </CardSocialMedia>
            ))}
          </div>
          <FormContact />
